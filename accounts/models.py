...
class Payment(models.Model):
    """Simple model to record donations/payments processed via Razorpay.

    Note: create migrations after adding this model: `python manage.py makemigrations` and `migrate`.
    """
    STATUS_CHOICES = (
        ("created", "Created"),
        ("paid", "Paid"),
    ...
    project_category = models.CharField(max_length=20, blank=True)
